                        ...
                        <div class="card">
                            <div class="card-header bg-primary">
                                @if (Route::current()->getName() == 'singleUser.paid')
                                    <div class="col-lg-12">
                                        <h3 class="card-title text" style="width: 100%; text-align:center">Total Payable From
                                            <strong>{{ Auth::user()->name }}</strong>
                                        </h3>
                                    </div>
                                @else
                                    <div class="col-lg-12">
                                        <h3 class="card-title text" style="width: 100%; text-align:center">Total Due From
