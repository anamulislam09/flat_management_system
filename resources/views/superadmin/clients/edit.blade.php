                    ...
                    <form action="{{ route('client.update') }}" method="POST">
                      ...
                      <div class="modal-body">
                        <div class="mb-3 mt-3">
                          ...
                          <input type="text" readonly class="form-control" value="{{ $data->name }}" name="name">
                        </div>

                        <div class="mb-3 mt-3">
                          <label for="user_phone" class="form-label">Phone:</label>
                          <input type="text" readonly class="form-control" value="{{ $data->phone }}" name="phone">
                        </div>
                        ...
                        <div class="mb-3 mt-3">
                          ...
                          <input type="text" class="form-control"
                            value="@if ($flat->sequence == null) ----- @elseif ($flat->sequence == 1)  A1,A2,A3
